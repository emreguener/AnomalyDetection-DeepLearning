...
from helpers_efficient import transform_image, load_models, predict, create_overlay, preprocess_input_image
import os
import numpy as np
...
def run_inference_efficient(img_path, img_id, output_dir,overlay):
    ...
    overlay, heatmap = create_overlay(processed_for_tensor, anomaly_map,overlay)
